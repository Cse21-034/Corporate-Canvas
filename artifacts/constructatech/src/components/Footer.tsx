      ...
      <div className="container mx-auto px-4 md:px-6 pt-12 md:pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-5 text-sidebar-foreground/70 max-w-sm text-sm leading-relaxed">
        ...
        {/* Affiliate Strip */}
        <div className="border-t border-sidebar-border pt-6 pb-6 md:pt-8 md:pb-8 flex flex-col sm:flex-row items-center justify-between gap-4 md:gap-6">
          <span className="font-mono-label text-sidebar-foreground/50 text-xs shrink-0">CERTIFIED PARTNERS</span>
